...
SCHEDULE_TIME = "09:00"      # Изменить: укажите время (например, "06:00")
...
PURCHASE_NOTIFY_ENABLED = True   # Изменить: True (вкл) или False (выкл)
...
ORDER_CHECK_INTERVAL_MINUTES = 5 # Изменить: интервал в минутах (от 5 до 1440)
